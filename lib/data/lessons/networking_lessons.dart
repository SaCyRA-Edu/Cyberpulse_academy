  ...
  Lesson(
    ...
    quiz: [
      QuizQuestion(
        ...
        options: [
          'Make DNS queries faster',
          'Limit lateral movement if one part of the network is compromised',
          'Increase bandwidth',
          'Replace firewalls',
        ],
        correctIndex: 1,
      ...
      QuizQuestion(
        ...
        correctIndex: 2,
        explanation: 'The TCP three-way handshake is SYN → SYN-ACK → ACK establishing a reliable connection.',
      ),
      QuizQuestion(
